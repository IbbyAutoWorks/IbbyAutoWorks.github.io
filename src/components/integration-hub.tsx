...
const links = [
  ...
  { label: "Vercel Project", href: "https://vercel.com/dashboard", note: "deployments, environment variables, serverless status API" },
  { label: "Vercel Live App", href: "https://ibbyautoworks.vercel.app/", note: "production web app" },
  { label: "GitHub App Repo", href: "https://github.com/IbbyAutoWorks/IbbyAutoWorks.github.io", note: "source, commits, GitHub Pages workflow" },
  { label: "Cloudflare Dashboard", href: "https://dash.cloudflare.com/", note: "DNS, domains, cache, security" },
