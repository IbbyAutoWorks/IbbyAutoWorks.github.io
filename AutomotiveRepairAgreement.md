================================================================================
          AUTOMOTIVE REPAIR AGREEMENT, LIABILITY WAIVER, & DISCLOSURE
================================================================================
...
YEAR/MILEAGE: ____________________________   PHONE: ___________________

Please read this document carefully before signing. By signing below, you authorize 
the repair work to be performed and explicitly agree to all terms, liability 
waivers, and financial disclosures outlined herein.

--------------------------------------------------------------------------------
1. ACKNOWLEDGMENT OF EXISTING AND HIDDEN VEHICLE DAMAGE
--------------------------------------------------------------------------------
Automobiles operate under extreme stress, heat, rust, and mechanical wear. The 
Customer acknowledges that they are bringing the vehicle in for repair because components 
are failing, weakened, or broken. 

The Customer agrees that during the course of normal disassembly, inspection, and 
...
--------------------------------------------------------------------------------
Once repairs are completed and the Customer is notified, the vehicle must be picked up 
...
================================================================================
By signing below, I certify that I am the legal owner (or authorized agent of the 
owner) of the vehicle listed above. I have read, completely understand, and agree 
to all the terms, liability limits, and disclosures in this multi-page document.
